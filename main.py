...
async def handle_filter_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        prompt = (
            ...
            "В этом сообщении должно быть меньше 2500 символов включая пробелы"
        )
...
async def handle_product(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        response = giga.chat(
            ...
            "Отзыв должен быть полезным, объективным и хорошо структурированным,а так же в нем должно быть меньше 2500 символов включая пробелы"
        )
