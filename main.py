...
async def handle_filter_price(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        prompt = (
            ...
            "5. ⭐ Рейтинг (если есть) в формате '⭐⭐⭐⭐☆ (4.5/5) \n\n"
            "Будь максимально конкретным и предоставляй актуальную информацию."
            "В этом сообщении должно быть меньше 1500 символов включая пробелы"
            "Информацию о товаре бери ИСКЛЮЧЕТЛЬНО с сайта производителя"
        )
...
async def handle_product(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        response = giga.chat(
            ...
            "Отзыв должен быть полезным, объективным и хорошо структурированным,а так же в нем должно быть меньше 1500 символов включая пробелы"
            "Информацию о товаре бери ИСКЛЮЧЕТЛЬНО с сайта производителя"
        )
